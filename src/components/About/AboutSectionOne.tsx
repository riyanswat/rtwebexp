        ...
        <div className="-mx-4 flex flex-wrap items-center">
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <p className="mb-8 text-base text-body-color">
              We are a Japan-based car exporting company, helping dealers and importers worldwide
              access Japanese vehicles. Our focus is on honesty, transparency and hassle-free exports.
            </p>
          </div>
...
//                   alt="about-image"
//                   fill
//                   // rounded-lg shadow-lg object-contain hidden dark:block
//                   className="rounded-lg mx-auto hidden max-w-full drop-shadow-three dark:block dark:drop-shadow-none lg:mr-0"
//                 />
//               </div>
//             </div>
//           </div>
