    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <a
          ...
          "
        >
          <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-md bg-[color:rgba(37,86,255,.10)] text-[var(--rt-primary)]">
            <PhoneIcon className="h-6 w-6" />
          </div>
          <div>
            <h4 className="text-lg font-semibold text-[var(--rt-ink)]">Phone (Japan)</h4>
            <p className="text-[var(--rt-ink-dim)] text-sm">+81-90-5776-3690</p>
            <p className="text-xs text-[color:rgba(63,76,111,.75)]">Tap to call our Main Office</p>
          </div>
        </a>
        ...
        <a
          ...
          className="flex items-start rounded-md border p-5 [box-shadow:var(--shadow-one)] transition-all hover:[box-shadow:var(--shadow-btn-hover)] hover:-translate-y-[1px]"
          style={{ borderColor: whatsappGreen }}
        >
          <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-md" style={{ backgroundColor: whatsappBg, color: whatsappGreen }}>
            <WhatsAppIcon />
          </div>
          <div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-start rounded-md border border-[var(--rt-ring)] bg-[var(--rt-surface)] p-5 [box-shadow:var(--shadow-one)] transition-all hover:[box-shadow:var(--shadow-btn-hover)] hover:-translate-y-[1px]"
        >
          <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-md bg-[color:rgba(37,86,255,.10)] text-[var(--rt-primary)]">
            <LocationIcon />
          </div>
          <div>
            <h4 className="text-lg font-semibold text-[var(--rt-ink)]">Address</h4>
            <p className="text-[var(--rt-ink-dim)] text-sm">Tatebayashi, Japan</p>
          </div>
        </a>

        <hr className="border-[var(--rt-ring)]" />

        {/* PRO ADDITION: Business Hours */}
        <div className="flex items-center space-x-3 text-[var(--rt-ink-dim)]">
          <ClockIcon className="h-5 w-5 text-[var(--rt-primary)]" />
          <p className="text-sm font-medium">Available: 9:00 AM - 8:00 PM (JST)</p>
        </div>
      </div>
    </div>
  );
...
// Small helper icons to keep the code clean
const WhatsAppIcon = () => (
